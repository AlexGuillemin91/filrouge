...
class CreateSurveyModel extends Database
{
     ...
     */
    public function createSurvey($title, $endDate, $topic, $answers)
    {
        ...
        $this->prepare("INSERT INTO `surveys` (`title`, `author_id`, `end_date`, `topic`) VALUES (:title, :authorPid, :endDate, :topic)", $datas);
